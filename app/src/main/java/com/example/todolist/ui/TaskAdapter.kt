...
class TaskAdapter(
    ...
    private val onCheckBoxClick: (Set<Task>) -> Unit
    ...
    class TaskViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val descriptionText: TextView = itemView.findViewById(R.id.text_view_description)
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        holder.descriptionText.text = task.description ?: "No description available"
        holder.deadlineText.text = if (task.deadline > 0) {
            "Deadline: ${
